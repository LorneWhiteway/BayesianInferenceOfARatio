...
\begin{frame}{Bayesian theory requires \textit{context}}
    ...
    \item{If you can generate plausible new `synthetic' measurement results then you have enough context.}
    \end{itemize}
\end{frame}
...
\begin{frame}{Posteriors for baryon/DM ratio from 2509.18967}
	\begin{figure}
	\centering
...
\begin{frame}{Bayes's theory works even for bad models}
 \begin{itemize}
    \item{We could have used these ideas to constrain the parameters even of a bad model.}
